...
const routes: Routes = [
  ...
  },
  {
    path:'navigation',component:NavigationComponent,children:[
      ...
      {
        path:'loans',loadChildren: () => import('./UI/LOANS/loans/loans/loans.module').then(m => m.LoansModule)
      },
      {
        path: 'chit', loadChildren: () => import('./UI/CHIT/chit/chit.module').then(m => m.ChitModule)
      },
      {
        path: 'transactions', loadChildren: () => import('./UI/TRANSACTIONS/transactions/transactions.module').then(m => m.TransactionsModule)
      },
      {
        path: 'reports', loadChildren: () => import('./UI/REPORTS/reports/reports.module').then(m => m.ReportsModule)
      },
      { 
        path: 'propertySetup', loadChildren: () => import('./UI/propertysetup/propertysetup.module').then(m => m.PROPERTYSETUPModule) 
      },
      { 
        path: 'tenantManagement', loadChildren: () => import('./UI/tenant-management/tenant-management.module').then(m => m.TenantManagementModule) 
      },
      { 
        path: 'paymentManagement', loadChildren: () => import('./UI/payment-management/payment-management.module').then(m => m.PaymentManagementModule) 
      },
    ]
  },
